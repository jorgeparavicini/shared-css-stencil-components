...
function componentConnected(element, ref, styleConnected) {
    var _a;
...
function componentDisconnected(element, ref) {
...
export { componentDisconnected as a, componentConnected as c };
