...
let contentRef, hostTagName, useNativeShadowDom = !1, checkSlotFallbackVisibility = !1, checkSlotRelocate = !1;
...
const createElm = (e, t, o, n) => {
 ...
 if (l.$tag$ = null, l.$flags$ |= 4, e.$vnode$ = l, l.$elm$ = s.$elm$ = o, 
 (contentRef = o["s-cr"], 
...
class Test2Component {
  ...
  render() {
    return (hAsync("div", null, hAsync("test-component", null), hAsync("test-component", null), hAsync("test-component", null), hAsync("test-component", null), hAsync("test-component", null), hAsync("test-component", null), hAsync("test-component", null)));
  }
  static get style() { return test2ComponentCss; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "test2-component",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class TestComponent {
  ...
  render() {
    return hAsync("p", { class: "test" }, "Test component");
  }
